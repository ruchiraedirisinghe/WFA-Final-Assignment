    ...
    public partial class CashierLoginForm : Form
    {
        ...
        private void gunaAdvenceButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try 
                {
                    SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=I:\Campus\NSBM\Y1S2\C#\Final project\WindowsFormsApp3\ss.mdf;Integrated Security=True;Connect Timeout=30");
